...
class CTScan(object):
    def __init__(self, seriesuid, centers, radii, clazz):
        ...
        paths = glob(os.path.join(RESOURCES_PATH,'*',self._seriesuid+".mhd"))
        path = paths[0]
    ...
    def save_preprocessed_image(self):
        ...
        print('D:/Projects/AI Diagnostics/Luna16/Output/preprocessed/'+subdir+'/'+self._seriesuid.split("\\")[0])
        try:
            os.mkdir('D:/Projects/AI Diagnostics/Luna16/Output/preprocessed/'+subdir+'/'+self._seriesuid.split("\\")[0])
        except:
            pass
    ...
    def get_augmented_patches(self):
        ...
        for i in range(len(self._coords)):
            ...
            for j in range(times_to_sample):
                ...
                print('D:/Projects/AI Diagnostics/Luna16/Output/preprocessed/'+subdir+'/'+self._seriesuid.split("\\")[0])
                try:
                    os.mkdir('D:/Projects/AI Diagnostics/Luna16/Output/augmented/'+subdir+'/'+self._seriesuid.split("\\")[0])
                except:
                    pass
